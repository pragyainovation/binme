import { addDoc, arrayUnion, collection, doc, getDoc, getDocs, limit, orderBy, query, serverTimestamp, updateDoc, where } from "firebase/firestore";
...
export async function getAllComplaints() { return ordered(await getDocs(query(collection(browserDb, "complaints"), orderBy("updatedAt", "desc"), limit(50)))); }
