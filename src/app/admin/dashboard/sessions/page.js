  ...
  const columns = [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return <div>
          <Link href={session.isFreeWebinar ? "/admin/dashboard/free-webinar" : `/admin/dashboard/sessions/${session.id}`} style={styles.viewLink} aria-label="View" title="View">&#128065;</Link>
          <Link href={session.isFreeWebinar ? "/admin/dashboard/free-webinar" : `/admin/dashboard/sessions/${session.id}/edit`} style={styles.editLink} aria-label="Edit" title="Edit">&#9998;</Link>
