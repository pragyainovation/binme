  ...
  return (
    <main style={styles.page}>
      <section style={styles.card}>
        ...
        <h1 style={styles.title}>Turn on session reminders</h1>
        <p style={styles.copy}>
          BinMe sends a browser notification 30 minutes before each webinar or session you register for. Enable notifications to continue to your dashboard.
        </p>
