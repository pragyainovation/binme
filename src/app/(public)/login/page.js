...
import { loginWithEmail, logout } from "@/features/auth/auth.service";
...
export default function LoginPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setError(submitError.code === "auth/invalid-credential" ? "Email or password is incorrect. If you just changed your password, use the new password." : (submitError.message || "Login failed."));
    } finally {
      setLoading(false);
    }
  };
