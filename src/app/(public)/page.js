        ...
        <div className="container webinar-box">
          ...
          <div className="webinar-content">
            ...
            <div className="event-details">
              <div>
                <span>Date</span>
                <b>{formatDateIST(webinar.date)}</b>
              </div>
              <div>
                <span>Time</span>
            ...
            {landingEvents.length > 1 ? <div style={{ display: "flex", gap: 10, marginTop: 18, alignItems: "center" }}><button type="button" onClick={() => showEvent(carouselIndex - 1)}>←</button><span>{carouselIndex + 1} / {landingEvents.length}</span><button type="button" onClick={() => showEvent(carouselIndex + 1)}>→</button></div> : null}
              </>
            )}
